                ...
                <div class="container">
                    <div class="column one">
                        ...
                        <ul class="breadcrumbs">
                            <li><?php echo CHtml::link('Home',array('site/index'), array('class'=>"")); ?><span><i class="icon-right-open"></i></span>
                            </li>
                            <li>Contact</li>
                        </ul>
                    </div>
  ...
  <div id="Content">
    <div class="content_wrapper clearfix">
                <div class="sections_group">
                    <h3 align="center" style="color:red;">Page under maintenance</h3>
                </div>
            </div>
  </div>
  <!-- Footer-->
...
<!-- Popup contact form -->
<?php  //require_once(Yii::app()->basePath . '/views/layouts/new-front-contact.php');?>
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/assets/front/new/js/jquery-2.1.4.min.js"></script>
    ...
    <script>
        function google_maps_54a672a1c80e7() {
            var latlng = new google.maps.LatLng(26.5188138, 80.4862254);
            var myOptions = {
                zoom: 10,
                center: latlng,
    ...
    <script>
        jQuery(window).load(function() {
            ...
            if (retina) {
                ...
                retinaEl.attr("src", "<?php echo Yii::app()->request->baseUrl; ?>/images/logo.png").width(retinaLogoW).height(retinaLogoH)
            }
        });
    </script>
</body>
