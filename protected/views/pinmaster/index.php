          ...
          <?php 
				...
				if(Yii::app()->user->getState('user_type')==0){	
					if($checkPermission[0]['adds']==0){
						echo CHtml::link('Add Pin <i class="fa fa-plus"></i>',array('pinmaster/create'), array('class'=>"btn btn-orange add-row"));
					}
				}
					?>
        </div>
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    <tr>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('no_pin')); ?></th>
                       <th><?php echo CHtml::encode($model->getAttributeLabel('amount')); ?></th>
                       <th><?php echo CHtml::encode($model->getAttributeLabel('flag')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('transfer_to')); ?></th>
