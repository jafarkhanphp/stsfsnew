        ...
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            <li> <i class="fa  clip-home"></i> <?php echo CHtml::link('<span class="title">Dashboard</span><span class=""></span>',array('user/dashboard'), array('class'=>"")); ?> </li>
              <li class=""><?php echo CHtml::link('<span class="title">Staff List</span><span class=""></span>',array('staff/index'), array('class'=>"")); ?> </li>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<?php $form=$this->beginWidget('CActiveForm', array(
										'id'=>'user-form', 'action'=>Yii::app()->createUrl('/user/staff_reset_password/id/'.$_GET['id']), 'enableAjaxValidation'=>false, 'clientOptions' => array(
