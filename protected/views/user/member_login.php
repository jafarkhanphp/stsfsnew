      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li > <i class="fa fa-groupe"></i> Members </li>
            <li class="active">Member Login List </li>
          </ol>
          <br />
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Member Login List <span class="" style="display: none" id="loader"><?php echo CHtml::image(Yii::app()->request->baseUrl."/assets/assets/images/loading.gif",'', array('width'=>"16", 'height'=>"16" , 'alt'=>"")); ?></span>
              <div class="panel-tools"> <a class="btn btn-xs btn-link panel-collapse collapses" href="#"> </a>     </div>
            </div>
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  <?php  $this->renderPartial('_member_login_search',array( 'model'=>$model,)); ?>
                  <thead>
                    <tr>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('usercode')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('username')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('password')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('branch_id')); ?></th>
                      <th>Action</th>
                    </tr>
                  </thead>
                  <?php $this->widget('zii.widgets.CListView', array(
													'dataProvider'=>$dataProvider,
													'itemView'=>'_member_login_view',
													)); 
											?>
                  <tr>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('usercode')); ?></th>
