      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo CHtml::link('Step pool List',array('steppools/index'), array('class'=>"")); ?> </li>
          </ol>
          <br>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Step pool
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Rid')); ?></th>
                       <th><?php echo CHtml::encode($model->getAttributeLabel('final_kevel')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('amount')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('steppool_bv')); ?></th>
                  ...
                  <?php $this->widget('zii.widgets.CListView', array(
													...
													'enableSorting'=>1,'sortableAttributes'=>array('id', 'final_kevel'
														),
													)); 
											?>
                  <tfoot>
