          ...
          <div class="col-sm-12">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="row">
				   <div class="col-sm-6">
                  <div class="modal-body"> 					<p><?php echo $form->labelEx($model2,'account_holder',array('class'=>"", 'for'=>"")); ?> <?php echo $form->textField($model2,'account_holder',array('size'=>10,'maxlength'=>200 , 'id'=>'account_holder', 'class'=>"form-control")); ?> <?php echo $form->error($model2,'account_holder'); ?> </p>
                    					<p><?php echo $form->labelEx($model2,'BankName',array('class'=>"", 'for'=>"")); ?> <?php echo $form->textField($model2,'BankName',array('size'=>10,'maxlength'=>200 , 'id'=>'BankName', 'class'=>"form-control")); ?> <?php echo $form->error($model2,'BankName'); ?> </p>
                       <p><?php echo $form->labelEx($model2,'AccNo',array('class'=>"", 'for'=>"")); ?> <?php echo $form->textField($model2,'AccNo',array('size'=>10,'maxlength'=>20 , 'id'=>'AccNo', 'class'=>"form-control", 'title'=>"Amount")); ?> <?php echo $form->error($model2,'AccNo'); ?> </p>
                    <p><?php echo $form->labelEx($model2,'adhar_no',array('class'=>"", 'for'=>"")); ?> 
					<?php echo $form->textField($model2,'adhar_no',array('size'=>10,'maxlength'=>20 , 'id'=>'adhar_no', 'class'=>"form-control", 'title'=>"Adhar Number")); ?> 
				 ...
				 <div class="col-sm-6">
                  <div class="modal-body"> 
					<p><?php echo $form->labelEx($model2,'BranchName',array('class'=>"", 'for'=>"")); ?> <?php echo $form->textField($model2,'BranchName',array('size'=>10,'maxlength'=>200 , 'id'=>'BranchName', 'class'=>"form-control")); ?> <?php echo $form->error($model2,'BranchName'); ?> </p>
                      <p><?php echo $form->labelEx($model2,'IFSC',array('class'=>"", 'for'=>"")); ?> <?php echo $form->textField($model2,'IFSC',array('size'=>10,'maxlength'=>14 , 'id'=>'AccNo', 'class'=>"form-control", 'title'=>"IFSC")); ?> <?php echo $form->error($model2,'IFSC'); ?> </p>
                    <p>
