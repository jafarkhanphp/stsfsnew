...
<div class="main-container">
  ...
  <div class="main-content"> 
    ...
    <div class="container"> 
      ...
      <!-- start: PAGE CONTENT -->
      <div class="row">
        <div class="col-md-12 space20"> <a class="btn btn-orange add-row">Create Member <i class="fa fa-plus"></i></a><?php 
		$checkPermission=Yii::app()->session['permissions'];
		
			if($checkPermission[0]['adds']==0){
				//echo CHtml::link('Create Member <i class="fa fa-plus"></i>',array(''), array('class'=>"btn btn-orange add-row"));
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Member List <span class="" style="display: none" id="loader"><?php echo CHtml::image(Yii::app()->request->baseUrl."/assets/assets/images/loading.gif",'', array('width'=>"16", 'height'=>"16" , 'alt'=>"")); ?></span>
              <div class="panel-tools"> <a class="btn btn-xs btn-link panel-collapse collapses" href="#"> </a> <a class="btn btn-xs btn-link panel-config" href="#panel-config" data-toggle="modal"> <i class="fa fa-wrench"></i> </a>    </div>
            </div>
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  <?php  $this->renderPartial('_list_search',array( 'model'=>$model,)); ?>
                  <thead>
                    <tr>
                     <th><?php echo CHtml::encode($model->getAttributeLabel('Joining Date')); ?></th>
                      <th class="center"><?php echo CHtml::encode($model->getAttributeLabel('Rid')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('SponserID')); ?></th>
                      <!--<th><?php //echo CHtml::encode($model->getAttributeLabel('ImmediateSponserId')); ?></th>-->
                      <!--<th><?php //echo CHtml::encode($model->getAttributeLabel('Position')); ?></th>-->
                      <th><?php echo CHtml::encode($model->getAttributeLabel('FirstName')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('username')); ?></th>
                       <th><?php echo CHtml::encode($model->getAttributeLabel('password')); ?></th>
                        <th><?php echo CHtml::encode($model->getAttributeLabel('ContactNo')); ?></th>
                      <th><?php echo CHtml::encode('id_status'); ?></th>
...
<script language="javascript">
			 ...
			 function status(Id) {//alert(Id);return false;
				 $("#loader").show();
				 jQuery.ajax({
                url: '<?php echo Yii::app()->request->baseUrl;?>/index.php/registrations/status',
                type: "POST",
                data: {id: Id},  
                success: function(data){//alert(data);return false;
                    ...
                    if(data==1){
						$("#loader").hide();
						alert('Status update successfuly');
						 window.location="<?php echo Yii::app()->request->baseUrl;?>/index.php/registrations/member";
					} else if(data==2){
						$("#loader").hide();
