...
<head>
<title>Member List :-<?php echo CHtml::encode($this->pageTitle); ?></title>
<!-- start: META -->
<meta charset="utf-8" />
  ...
  <div class="main-content"> 
    ...
    <div class="container"> 
      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">My Member List</li>
          </ol>
          <br />
      ...
      <div class="row">
		...
		<?php echo CHtml::link('Create Member <i class="fa fa-plus"></i>',array('registrations/create'), array('class'=>"btn btn-orange add-row"));?>
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> My Member List <span class="" style="display: none" id="loader"><?php echo CHtml::image(Yii::app()->request->baseUrl."/assets/assets/images/loading.gif",'', array('width'=>"16", 'height'=>"16" , 'alt'=>"")); ?></span>
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    <tr>
                       <th><?php echo CHtml::encode($model->getAttributeLabel('Level No')); ?></th>
                       <th><?php echo CHtml::encode($model->getAttributeLabel('Member Id')); ?></th>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('activation_date')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Sponsor Id')); ?></th>
                       <th><?php echo CHtml::encode($model->getAttributeLabel('Place Under ID')); ?></th>
                     <th>Action</th>
                    </tr>
                  </thead>
