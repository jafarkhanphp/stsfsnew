...
<head>
<title>My Direct Sponsor :-<?php echo CHtml::encode($this->pageTitle); ?></title>
<!-- start: META -->
<meta charset="utf-8" />
      ...
      <div class="row">
		...
		<?php  
			...
			if($checkPermission[0]['adds']==0){
				echo CHtml::link('Register New Member <i class="fa fa-plus"></i>',array('registrations/create'), array('class'=>"btn btn-orange add-row"));
			}	?>
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Member List 
			              <div class="panel-tools"> <a class="btn btn-xs btn-link panel-collapse collapses" href="#"> </a>  </div>
            </div>
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  <?php  $this->renderPartial('_direct_search',array( 'model'=>$model,)); ?>
                  <thead>
                    <tr>
                       <th><?php echo CHtml::encode($model->getAttributeLabel('Rid')); ?></th>
					   <th><?php echo CHtml::encode($model->getAttributeLabel('BinaryPosition')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('FirstName')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('RegistrationDate')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('package_id')); ?></th>
