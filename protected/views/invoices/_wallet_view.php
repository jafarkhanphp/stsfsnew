<?php $checkPermission=Yii::app()->session['permissions']; ?>
 <tbody>
  <tr>
   ...
   <td> <?php if($data->payment_status!=0){ echo '<span class="label label-sm label-success">Paid</span>';
    ...
    <td><?php if($data->payment_status!=0){echo CHtml::encode(date('d-m-Y',strtotime($data->payment_date)));} ?></td>
