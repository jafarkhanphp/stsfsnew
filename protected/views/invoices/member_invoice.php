    ...
    <div class="container"> 
      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            <li> <i class="fa  clip-home"></i> <?php echo CHtml::link('<span class="title">Dashboard</span><span class=""></span>',array('user/member_dashboard'), array('class'=>"")); ?> </li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Invoice List (<?php echo Yii::app()->user->getState('usercode');?>) <span class="" style="display: none" id="loader"><?php echo CHtml::image(Yii::app()->request->baseUrl."/assets/assets/images/loading.gif",'', array('width'=>"16", 'height'=>"16" , 'alt'=>"")); ?></span>
              <div class="panel-tools"> <a class="btn btn-xs btn-link panel-collapse collapses" href="#"> </a>     </div>
            </div>
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  <?php  $this->renderPartial('_member_invoice_search',array( 'model'=>$model,)); ?>
                  <thead>
                    <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('net_payable_amount')); ?></th>
