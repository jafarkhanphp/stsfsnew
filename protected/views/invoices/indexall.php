      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
           ...
           <li> <?php echo CHtml::link('<span class="title">Final Invoices</span><span class=""></span>',array('invoices/index'), array('class'=>"")); ?> </li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Invoice List <span class="" style="display: none" id="loader"><?php echo CHtml::image(Yii::app()->request->baseUrl."/assets/assets/images/loading.gif",'', array('width'=>"16", 'height'=>"16" , 'alt'=>"")); ?></span>
                ...
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('level_income')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('team_income')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('direct_income')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('total_income')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('payable_income')); ?></th>
