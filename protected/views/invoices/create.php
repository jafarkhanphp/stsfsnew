      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li> Invoices </li>
            <li class="active">Create Invice </li>
          </ol>
          <br />
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Generate Invoice <span class="" style="display: none" id="loader"><?php echo CHtml::image(Yii::app()->request->baseUrl."/assets/assets/images/loading.gif",'', array('width'=>"16", 'height'=>"16" , 'alt'=>"")); ?></span>
              <div class="panel-tools"> <a class="btn btn-xs btn-link panel-collapse collapses" href="#"> </a>     </div>
            </div>
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1" style="width:50%">
                  ...
                  <tr>
                 <td><form method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/invoices/create">
                <?php $cdate=Invoices::model()->getDate();
				if($cdate==0){?>
                 <input type="submit" name="Invoices" class="btn btn-green btn-sm" value="Generate Invoice">
                 <?php }else{echo 'Invoice has been created';}?>
