        ...
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li> <i class="fa  clip-note"></i> Report </li>
             <li> <i class="fa  clip-note"></i> <?php echo CHtml::link('<span class="title">TDS</span><span class=""></span>',array('invoices/tds_report'), array('class'=>"")); ?> </li>
            <li class="active">TDS Listing</li>
          </ol>
          <br />
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> TDS List <span class="" style="display: none" id="loader"><?php echo CHtml::image(Yii::app()->request->baseUrl."/assets/assets/images/loading.gif",'', array('width'=>"16", 'height'=>"16" , 'alt'=>"")); ?></span>
              <div class="panel-tools"> <a class="btn btn-xs btn-link panel-collapse collapses" href="#"> </a>     </div>
            </div>
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  <?php  $this->renderPartial('_index_tds_search',array( 'model'=>$model,)); ?>
                  <thead>
                    <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('TDS Amount')); ?></th>
                      <th>Action</th>
                    </tr>
                  </thead>
                  <?php $this->widget('zii.widgets.CListView', array(
													'dataProvider'=>$dataProvider,
													'itemView'=>'_index_tds_view',
													)); 
											?>
                  <tr>
                      <th class="center"><?php echo CHtml::encode($model->getAttributeLabel('id')); ?></th>
