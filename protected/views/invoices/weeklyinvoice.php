      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Weekly Invoice Details </li>
          </ol>
          <br />
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Weekly Invoice Details <span class="" style="display: none" id="loader"><?php echo CHtml::image(Yii::app()->request->baseUrl."/assets/assets/images/loading.gif",'', array('width'=>"16", 'height'=>"16" , 'alt'=>"")); ?></span>
              <div class="panel-tools"> <a class="btn btn-xs btn-link panel-collapse collapses" href="#"> </a>     </div>
            </div>
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  <?php  //$this->renderPartial('_wallet_search',array( 'model'=>$model,)); ?>
                  <thead>
                    <tr>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Invoice Date')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('tds')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('service_charge')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Level Income')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Sponsor Income')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Total Amount')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Payable Amount')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('payment_status')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('payment_date')); ?></th>
