      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li> <i class="fa  clip-note"></i> Invoices </li>
            <li class="active">Month Vise Invoice </li>
          </ol>
          <br />
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="sample-table-1">
                  <?php  $this->renderPartial('_invoice_wise_search',array( 'model'=>$model,)); ?>
                  <thead>
                    <tr>
                      ...
                      <th><?php echo CHtml::encode('No of Invoice'); ?></th>
                      <th><?php echo CHtml::encode('Total Amt.'); ?></th>
					  <th><?php echo CHtml::encode('Handling Charges'); ?></th>
					  <th><?php echo CHtml::encode('Gross Amt.'); ?></th>
