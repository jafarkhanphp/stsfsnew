...
<head>
<title>Invoice List  : <?php echo CHtml::encode($this->pageTitle); ?></title>
<!-- start: META -->
<meta charset="utf-8" />
      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li> <i class="fa  clip-note"></i> <?php echo CHtml::link('<span class="title">Final Invoices</span><span class=""></span>',array('invoices/invice_wise_listing'), array('class'=>"")); ?> </li>
            <li class="active">Final Invoice </li>
          </ol>
          <br />
                ...
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('cycle_date_from')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('cycle_date_to')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Total MBV Amt')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Single Leg Payout')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('gross_amount')); ?></th>
                  ...
                  <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('cycle_date_from')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('cycle_date_to')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('total_bv')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('Single Leg Payout')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('gross_amount')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('payment_status')); ?></th>
                      <th>Action</th>
