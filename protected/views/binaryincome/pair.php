      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li class="">Reports </li>
             <li class="active"><?php echo CHtml::link('<span class="title">Pair Income</span><span class=""></span>',array('binaryincome/pair/RID/'.base64_encode($id)), array('class'=>"")); ?></li>
          </ol>
          <br>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Pair Income List 
                ...
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('agg_left_bv')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('agg_right_bv')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('left_bv')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('right_bv')); ?></th>
                  ...
                  <?php $this->widget('zii.widgets.CListView', array(
													...
													'enableSorting'=>1,'sortableAttributes'=>array('total_bv'),)); 
											?>
                  <tfoot>
                   <tr>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('RID')); ?></th>
			 ...
			 function status(Id) {
			  ...
			  function deleteRecord(Id) {
				...
				// return confirm("Are you sure?");
				 jQuery.ajax({
                url: '<?php echo Yii::app()->request->baseUrl;?>/index.php/branch/delete',
                type: "POST",
                data: {id: Id},  
                success: function(data){
                    if(data==1){
						$("#"+Id).hide();
						window.location="<?php echo Yii::app()->request->baseUrl;?>/index.php/branch/index";
					} 
					else if(data==2) {
						$("#loader").hide();
