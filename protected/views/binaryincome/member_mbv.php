...
<head>
<title>Matching BV Income List :-<?php echo CHtml::encode($this->pageTitle); ?></title>
<!-- start: META -->
<meta charset="utf-8" />
      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Matching BV Income List</li>
          </ol>
          <br />
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Matching BV Income List
                ...
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    <tr>
					  ...
					  <th><?php echo CHtml::encode($model->getAttributeLabel('caping')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('total_bv_amt')); ?></th>
                       <th><?php echo CHtml::encode($model->getAttributeLabel('created')); ?></th>
					   <th><?php echo CHtml::encode($model->getAttributeLabel('Payment Status')); ?></th>
					   <th></th>
			           
                    </tr>
                  </thead>
               
                  <?php $this->widget('zii.widgets.CListView', array(	'dataProvider'=>$dataProvider,'itemView'=>'_member_view',)); 
											?>
