...
<!-- start: HEAD -->
<head>
<title>Wallet History : <?php echo CHtml::encode($this->pageTitle); ?></title>
<!-- start: META -->
<meta charset="utf-8" />
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Wallet History
                ...
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('account_head_name')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('credit')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('debit')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('balance')); ?></th>
