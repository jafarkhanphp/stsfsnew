...
<!-- start: HEAD -->
<head>
<title>Withdrawal  request :- <?php echo CHtml::encode($this->pageTitle); ?></title>
<!-- start: META -->
<meta charset="utf-8" />
  ...
  <div class="main-content"> 
    ...
    <div class="container"> 
      ...
      <div class="row">
		...
		<?php 
				 echo CHtml::link('Withdraw List  <i class="fa clip-list-6"></i>',array('paymentRequest/widthdraw_list'), array('class'=>"btn btn-orange add-row"));
			?>
        </div>
        <div class="col-md-12"> 
          ...
          <div class="panel panel-default">
            <?php
								...
								?>
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i>Withdrawal  Request
              ...
              <div class="modal-body">
                <?php $form=$this->beginWidget('CActiveForm', array(
                    ...
                    <div class="col-md-12">
                     ...
                     <?php echo $form->labelEx($model,'payment_mod',array('class'=>"control-label", 'for'=>"")); ?>
                      <?php 
						     $statusOptions = array('0' => 'Cash', '1' => 'Check', '2' => 'NFT' );
							echo $form->dropDownList($model, 'payment_mod', $statusOptions, array( 'prompt' => 'Select payment mod' , 'id'=>"payment_mod", 'class'=>"form-control"));?>
                             <?php echo $form->error($model,'payment_mod'); ?>	
                    </div>
                     <div class="form-group">
                           <?php echo $form->labelEx($model,'amount',array('class'=>"control-label", 'for'=>"")); ?>
                           <?php echo $form->textField($model,'amount',array('size'=>10,'id'=>'amount', 'value'=>$totalWalletAmount,  'class'=>"form-control")); ?>
                     ...
                     <div class="col-sm-6">
											<button class="btn btn-icon btn-block">
												<i class="fa fa-rupee"></i><?php echo $totalWalletAmount;?><br>
												E- Wallet Amount 
											</button>
										</div>
                     </div>
