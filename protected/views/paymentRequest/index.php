...
<title>Payment Request  : <?php echo CHtml::encode($this->pageTitle); ?></title>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Payment Request 
                ...
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('request_date')); ?></th>

                      <th><?php echo CHtml::encode($model->getAttributeLabel('amount')); ?></th>

                      <th><?php echo CHtml::encode($model->getAttributeLabel('payment_mode')); ?></th>

                      <th><?php echo CHtml::encode($model->getAttributeLabel('Cheque_UTR')); ?></th>

                      <th><?php echo CHtml::encode($model->getAttributeLabel('status')); ?></th>

                      <th><?php echo CHtml::encode($model->getAttributeLabel('status_update_date')); ?></th>

                      <th><?php echo CHtml::encode($model->getAttributeLabel('remarks')); ?></th>
				 ...
				 <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('payment_mod')); ?></th>
