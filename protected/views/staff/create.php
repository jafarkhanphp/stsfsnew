      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa clip-user"></i> <?php echo CHtml::link('<span class="title">Staff List</span><span class="selected"></span>',array('staff/index'), array('class'=>"")); ?> </li>
            <li class="active"> <i class="fa fa clip-user"></i> Create Staff </li>
          </ol>
          <br>
              ...
              <div class="panel-body">
			    ...
			    echo $form->dropDownList($model, 'user_type', $statusOptions, array( 'prompt' => 'Select user type' , 'id'=>"form-field-select-3", 'class'=>"form-control search-select")); ?> <?php echo $form->error($model,'user_type'); ?> </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group"> <?php echo $form->labelEx($model1,'password',array('class'=>"control-label", 'for'=>"")); ?> <?php echo $form->passwordField($model1,'password',array('size'=>10,'maxlength'=>100 , 'id'=>'password', 'class'=>"form-control", 'title'=>"Entre password")); ?> <?php echo $form->error($model1,'password'); ?> </div>
                        
                        
                          <div class="form-group"> <?php echo $form->labelEx($model1,'conformpassword',array('class'=>"control-label", 'for'=>"")); ?> <?php echo $form->passwordField($model1,'conformpassword',array('size'=>10,'maxlength'=>100 , 'id'=>'conformpassword', 'class'=>"form-control", 'title'=>"Entre confirm password")); ?> <?php echo $form->error($model1,'conformpassword'); ?> </div>
