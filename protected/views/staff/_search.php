...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'basic_sallery'); ?>
		<?php echo $form->textField($model,'basic_sallery'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'qualification',array('size'=>10,'maxlength'=>10)); ?>
	</div>
