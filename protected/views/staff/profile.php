          ...
          <div class="col-sm-12">
            <div class="panel panel-default">
              <?php
								...
								?>
              <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Fill Profile  Details
              ...
              <div class="panel-body">
                <div class="modal-body">
                  ...
                  <div class="model-body"> 
                    ...
                    <div class="col-sm-2"> <?php echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Update',array('class'=>"btn btn-bricky btn-lg")); ?> </div>
