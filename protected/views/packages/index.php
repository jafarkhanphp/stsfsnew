...
<head>
<title>Packages:- <?php echo CHtml::encode($this->pageTitle); ?></title>
<!-- start: META -->
<meta charset="utf-8" />
        ...
        <div class="col-md-12 space20">
          <?php 
					...
					if($checkPermission[0]['adds']==0){
						echo CHtml::link('Add Packages <i class="fa fa-plus"></i>',array('packages/create'), array('class'=>"btn btn-orange add-row"));
					}?>
        </div>
        <div class="col-md-12">
          <?php
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Packages List <span class="" style="display: none" id="loader"><?php echo CHtml::image(Yii::app()->request->baseUrl."/assets/assets/images/loading.gif",'', array('width'=>"16", 'height'=>"16" , 'alt'=>"")); ?></span>
                ...
                <table class="table table-bordered table-hover" id="sample-table-1">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th><?php echo CHtml::encode($model->getAttributeLabel('package_name')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('amount')); ?></th>
                      <th><?php echo CHtml::encode($model->getAttributeLabel('bv')); ?></th>
                  ...
                  <?php $this->widget('zii.widgets.CListView', array(
													...
													'itemView'=>'_view',
													'enableSorting'=>1,'sortableAttributes'=>array('package_name', 'bv'
														),
													)); 
											?>
                  <tfoot>
