...
<head>
<title>Packages Create:- <?php echo CHtml::encode($this->pageTitle); ?></title>
<!-- start: META -->
<meta charset="utf-8" />
...
<div class="main-container">
      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> </i> Create Package </li>
          </ol>
          <br>
 ...
 <?php $form=$this->beginWidget('CActiveForm', array('id'=>'Packages',  'enableAjaxValidation'=>false,  'enableClientValidation'=>false, 'htmlOptions' => array('enctype' => 'multipart/form-data'))); ?>
			...
			echo $form->dropDownList($model, 'category_id', $listdata3, array('prompt' => 'Select Category','class'=>"form-control",'id'=>""));?>
