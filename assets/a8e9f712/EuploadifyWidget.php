...
class EuploadifyWidget extends CInputWidget 
{
    ...
    */
	public function run() 
	{
        ...
        $clientScript->registerScriptFile($this->baseUrl. 'extensions/uploadify/jquery.uploadify.v2.1.0.min.js', CClientScript::POS_HEAD);
		$clientScript->registerScriptFile($this->baseUrl . 'extensions/uploadify/swfobject.js', CClientScript::POS_HEAD); 
