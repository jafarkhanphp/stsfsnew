...
class EuploadifyWidget extends CInputWidget 
{
    ...
    */
	public function run() 
	{
        ...
        $clientScript->registerScriptFile(Yii::app()->request->baseUrl. '/protected/extensions/uploadify/jquery.uploadify.v2.1.0.min.js', CClientScript::POS_HEAD);
		$clientScript->registerScriptFile(Yii::app()->request->baseUrl . 'protected/extensions/uploadify/swfobject.js', CClientScript::POS_HEAD); 
