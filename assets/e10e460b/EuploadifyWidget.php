...
class EuploadifyWidget extends CInputWidget 
{
    ...
    */
	public function run() 
	{
        ...
        $clientScript->registerScriptFile(Yii::app()->request->baseUrl. '/assets/js/jquery.uploadify.v2.1.0.min.js', CClientScript::POS_HEAD);
		$clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/assets/js/swfobject.js', CClientScript::POS_HEAD); 
		$clientScript->registerCssFile(Yii::app()->request->baseUrl. '/css/uploadify.css');
